...
namespace RemoteService.MyWindow
{
    ...
    public partial class AddRunner  : MyChildWindow
    {
        ...
        private void LoadFileData()
        {
            ...
            //this.pictureBox_AddRunner.Image = RemoteService.Properties.Resources.addUser;
        ...
        private void FreezeAdd()
        {
            ...
            //this.pictureBox_AddRunner.Image = RemoteService.Properties.Resources.addUser2;
        }
        ...
        {
            FreezeAdd();
            myOwner = (RunnerRemoteService)this.Owner;
        }
